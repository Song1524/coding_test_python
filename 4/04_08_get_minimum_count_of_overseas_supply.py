...
# 1. stock 보다 작거나 같은 dates를 찾고
# 2. 찾은 dates 중 가장 큰 공급량을 찾아서 stock에 더한 후 후보에서 제외
# 3. 다시 stock 보다 작거나 같은 dates를 찾아서 그 중 가장 큰 공급량을 stock에 더함
# 4. stock >= k 까지 반복
...
def get_minimum_count_of_overseas_supply(stock, dates, supplies, k):
    ...
    while stock < k:
        ...
        largest_supplies = heapq.heappop(heap) * -1
        stock += largest_supplies
